...
class EasyBox:
    def __init__(self, center,rotation_center, width, height, depth, ax="none", color = (0.3,0.3,1,1)):
...
class EasyDrawer:
    ...
    def add_box(self, center,rotation_center, width, height, depth, color = (0.3,0.3,1,1)):
        new_box = EasyBox(center=center,rotation_center=rotation_center, width=width, height=height, depth=depth, ax=self.ax, color=color)
...
model.ax.view_init(elev=30, azim=130)
#model.fig.show()
#plt.ion()
